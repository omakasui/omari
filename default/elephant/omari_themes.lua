--
-- Dynamic Omari Theme Menu for Elephant/Walker
--
Name = "omarithemes"
NamePretty = "Omari Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omari/themes"
  local omari_path = os.getenv("OMARI_PATH") or ""
  local default_theme_dir = omari_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omari-theme-set " .. theme_name,
            },
          })
        end
      end
